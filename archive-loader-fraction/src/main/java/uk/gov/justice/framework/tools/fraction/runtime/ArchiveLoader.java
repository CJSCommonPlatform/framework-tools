...
public class ArchiveLoader implements DeploymentProcessor {
    ...
    public void process() {
        ...
        final FrameworkLibraries frameworkLibraries = new FrameworkLibraries(
                ...
                "uk.gov.justice.event-store:event-publisher-jms",
                "uk.gov.justice.event-store:event-listener-interceptors",
                "uk.gov.justice.event-store:event-publisher-process",
                "uk.gov.justice.event-store:event-source",
                "uk.gov.justice.event-store:event-store-util",
                "uk.gov.justice.event-store:event-subscription",
                "uk.gov.justice.event-store:subscription-manager",
